/*Justin Liu, jl8wf    Filename: inlab4.cpp     Date:9/24/2020  */
#include <iostream>
#include <stdio.h>
#include <string>
...
int main(){
  ...
  double * py = NULL;
	...
	// cout << y << endl;
	// cout << px << endl;
	//cout << z << endl; //0xffffe014 when x = 2, 0xffffe014 when x = 2147483647, 0x00000000 when x = 0,
	                   //second int pointer value is 0xffffe010
	                   //third int pointer value is  0xffffe00c
	return 0;
}
