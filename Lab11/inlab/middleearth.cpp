...
#include <cmath>
/**
 *@file middleearth.cpp The cpp file of the MiddleEarth Object.
 *@brief New shuffle method that uses the Mersenne Twister engine
 *@details The shuffle method will take in the first and last elements of a vector of strings and 
 *shuffles the distance between the cities by using a for loop
 *
 *@return Does not return anything. This fuction is a modifier.
 *@param first An iterator representing the first element in a vector of strings.
 *@param last An iterator representing the last element in a vector of strings.
 *@param g The Mersenne-Twister random number engine.
 */
...
/**
 *@brief array of strings, size 40, initalize with variable name all_city_names
 *@note The list of all the place names that we'll be using. There are 40 cities/villages/towns belonging to the various races.
 */
 ...
 *@brief Prints out info on the created 'world' such as the number of cities, what those cities are called, and their location on the map
...
/**
 *@brief Prints out a table that has the columns of location, x and y position. Also pritn out *the distance between each city.
 *@return Does not return anything. It is a void member function of MiddleEarth.
*/
